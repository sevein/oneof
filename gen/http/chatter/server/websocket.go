...
// Send streams instances of "chatter.OneofEvent" to the "subscribe" endpoint
// websocket connection.
func (s *SubscribeServerStream) Send(v *chatter.OneofEvent) error {
	var err error
	...
	res := chatter.NewViewedOneofEvent(v, "default")
	body := NewSubscribeResponseBody(res.Projected)
